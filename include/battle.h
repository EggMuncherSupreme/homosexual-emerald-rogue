...
struct DisableStruct
{
    ...
    u8 machineLearningPhys:1;
    u8 machineLearningSpec:1;
};
...
struct BattleStruct
{
    ...
    u8 fightingSpiritBoost[NUM_BATTLE_SIDES];
...
#define IS_MOVE_RECOIL(move)(IS_EFFECT_RECOIL(gBattleMoves[move].effect) || gBattleMoves[move].effect == EFFECT_EXPLOSION)
...
#define IS_BATTLER_PROTECTED(battlerId)(gProtectStructs[battlerId].protected                                           \
                                        ...
                                        || gProtectStructs[battlerId].stunShielded)
