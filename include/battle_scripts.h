...
extern const u8 BattleScript_IceRinkHeal[];
extern const u8 BattleScript_QuarryHeal[];
extern const u8 BattleScript_SmelteryHeal[];
...
extern const u8 BattleScript_SelectingNotAllowedRunningStart[];
extern const u8 BattleScript_MoveRunningStartPrevents[];
extern const u8 BattleScript_MoveUsedGravityPrevents[];
extern const u8 BattleScript_SelectingNotAllowedMoveGravityInPalace[];
extern const u8 BattleScript_SelectingNotAllowedRunningStartInPalace[];
...
extern const u8 BattleScript_EmergencyExitNoSwitch[];
...
extern const u8 BattleScript_ActivateBigBalls[];
...
extern const u8 BattleScript_StickyHeld[];
...
extern const u8 BattleScript_LiquidOozeActivates[];
...
extern const u8 BattleScript_HealerRestoreActivates[];
