...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    // VGC Pride Moves
    [MOVE_ONSLAUGHT_CORE] = _("Onslaught Core"),
    [MOVE_DIVE_BOMB] = _("Dive Bomb"),
    [MOVE_DIVINE_SMITE] = _("Divine Smite"),
    [MOVE_EXPANDING_MAWS] = _("Expanding Maws"),
    [MOVE_FLASH_FREEZE] = _("Flash Freeze"),
    [MOVE_PSYCH_OUT] = _("Psych Out"),
    [MOVE_ICE_RINK] = _("Ice Rink"),
    [MOVE_QUARRY] = _("Quarry"),
    [MOVE_SMELTERY] = _("Smeltery"),
    [MOVE_SLUSH_CRUSH] = _("Slush Crush"),
...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    // VGC Pride Moves
    [MOVE_ONSLAUGHT_CORE] = _("OnslaugtCore"),
    [MOVE_DIVE_BOMB] = _("Dive Bomb"),
    [MOVE_DIVINE_SMITE] = _("Divine Smite"),
    [MOVE_EXPANDING_MAWS] = _("ExpandngMaws"),
    [MOVE_FLASH_FREEZE] = _("Flash Freeze"),
    [MOVE_PSYCH_OUT] = _("Psych Out"),
    [MOVE_ICE_RINK] = _("Ice Rink"),
    [MOVE_QUARRY] = _("Quarry"),
    [MOVE_SMELTERY] = _("Smeltery"),
    [MOVE_SLUSH_CRUSH] = _("Slush Crush"),
    [MOVE_PURIFYING_WATER] = _("PurifyngWatr"),
    [MOVE_STALACBITE] = _("Stalacbite"),
