...
static const u8 sColorChangeDescription[] = _("Change to best type.");
...
static const u8 sIlluminateDescription[] = _("Accuracy increases.");
...
static const u8 sMagmaArmorDescription[] = _("Reduces contact damage.");
...
static const u8 sRunAwayDescription[] = _("Can't be trapped.");
...
static const u8 sLiquidOozeDescription[] = _("Food becomes rotten.");
...
static const u8 sSwarmDescription[] = _("Ups allies Bug moves.");
...
static const u8 sLeafGuardDescription[] = _("Protects allies in sunshine.");
...
static const u8 sIceBodyDescription[] = _("Frostbite on contact.");
...
#endif
static const u8 sHoneyGatherDescription[] = _("Pollen Puff is boosted.");
...
static const u8 sUnnerveDescription[] = _("Lowers the foe's Sp. Atk.");
...
static const u8 sHeavyMetalDescription[] = _("Boosts defenses slightly.");
...
static const u8 sJustifiedDescription[] = _("Dark, Intimidate raise Attack.");
...
static const u8 sZenModeDescription[] = _("Transforms at 3/4 HP.");
...
static const u8 sMegaLauncherDescription[] = _("Boosts pulse, bullet moves.");
static const u8 sGrassPeltDescription[] = _("Ups stats in grass.");
...
static const u8 sWimpOutDescription[] = _("Attack, flees at 1/2 HP.");
...
static const u8 sBerserkDescription[] = _("Boosts offenses at low HP.");
...
static const u8 sCorrosionDescription[] = _("Poison hits any type.");
...
static const u8 sTanglingHairDescription[] = _("Contact lowers Speed, traps.");
...
static const u8 sPastelVeilDescription[] = _("Protects team from status.");
...
static const u8 sAsOneIceRiderDescription[] = _("Symbiosis and Chilling Neigh.");
static const u8 sAsOneShadowRiderDescription[] = _("Symbiosis and Grim Neigh.");
static const u8 sLingeringAromaDescription[] = _("Others become slower.");
...
static const u8 sGuardDogDescription[] = _("Shields ally from first move.");
static const u8 sRockyPayloadDescription[] = _("Powers up Rock, Bomb moves.");
...
static const u8 sOrichalcumPulseDescription[] = _("Boosts damage in Sun.");
static const u8 sHadronEngineDescription[] = _("Boosts on E. Terrain.");
...
static const u8 sMyceliumMightDescription[] = _("Powder moves are last.");
...
static const u8 sSupersweetSyrupDescription[] = _("Lowers the foe's evasion.");
...
static const u8 sRampageDescription[] = _("KOs prevent downsides.");
