...
static const struct FormChange sMewtwoFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_SWITCH,           SPECIES_MEWTWO_MEGA_X, ABILITY_MEGA_SHIFT_X},
    {FORM_CHANGE_BATTLE_SWITCH,           SPECIES_MEWTWO_MEGA_Y, ABILITY_MEGA_SHIFT_Y},
...
static const struct FormChange sDarmanitanFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_STANDARD_MODE, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   75},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_ZEN_MODE,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 75},
...
static const struct FormChange sDarmanitanGalarianFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALARIAN_STANDARD_MODE, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   75},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALARIAN_ZEN_MODE,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 75},
...
static const struct FormChange sCramorantFormChangeTable[] = {
    {FORM_CHANGE_BEGIN_BATTLE,      SPECIES_CRAMORANT_GULPING},
