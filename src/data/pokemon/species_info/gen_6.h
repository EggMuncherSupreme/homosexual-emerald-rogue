...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_FLARE_BOOST, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_FLAME_BODY, ABILITY_MOLTEN_DOWN, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_SYMBIOSIS, ABILITY_FAIRY_AURA },  \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_LAWN_SURFER, ABILITY_GRASS_PELT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_GLUTTONY, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SNIPER, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_NONE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_DRAGON },
        .abilities = { ABILITY_STRONG_JAW, ABILITY_RAMPAGE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_DRAGON },
        .abilities = { ABILITY_STRONG_JAW, ABILITY_RAMPAGE, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_PRANKSTER, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define PUMPKABOO_MISC_INFO                                                 \
        ...
        .abilities = { ABILITY_GROWING_PUMPKIN, ABILITY_NONE },   \
        .bodyColor = BODY_COLOR_BROWN,                                      \
...
#define AVALUGG_MISC_INFO                               \
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .baseSpDefense = 46,
        .types = { TYPE_ICE, TYPE_ICE },
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_ICE_BODY, ABILITY_STURDY },
        .height = 20,
        .weight = 5050,
        .description = POKEDEX_DESC_STRING(
...
,
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SOLID_ROCK, ABILITY_STURDY },
        .height = 14,
        .weight = 2624,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
            ...
            .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        #endif
        .abilities = { ABILITY_FRISK, ABILITY_INFILTRATOR, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define HOOPA_MISC_INFO                                                                 \
        ...
        .growthRate = GROWTH_SLOW,                                                      \
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },    \
        .abilities = { ABILITY_MAGICIAN, ABILITY_NONE, ABILITY_LOOPHOLE },              \
        .bodyColor = BODY_COLOR_PURPLE,                                                 \
        .speciesName = _("Hoopa"),                                                      \
