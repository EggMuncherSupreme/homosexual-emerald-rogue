...
u32 GetBattlerTotalSpeedStatArgs(u32 battler, u32 ability, u32 holdEffect)
{
    ...
    {
        if (ability == ABILITY_ARCTIC_RUSH && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && gBattleWeather & (B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW))
            speed *= 2;
        else if ((ability == ABILITY_SWIFT_SWIM)       && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && gBattleWeather & B_WEATHER_RAIN)
            speed *= 2;
